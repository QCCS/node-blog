...
--
-- Host: localhost    Database: node_blog_test
-- ------------------------------------------------------
...
--
-- Current Database: `node_blog_test`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `node_blog_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `SequelizeMeta` VALUES ('00-user.js'),('01-role.js'),('02-permission.js'),('03-user_role.js'),('04-role_permission.js'),('05-image.js'),('06-comment.js'),('07-post.js'),('08-tag.js'),('09-post_comment.js'),('10-post_like.js'),('11-post_read.js'),('11-post_tag.js'),('12-access_token.js'),('13-refresh_token.js');
...
CREATE TABLE `post_comment` (
  ...
  CONSTRAINT `post_comment_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `post` (`id`),
  CONSTRAINT `post_comment_ibfk_2` FOREIGN KEY (`comment_id`) REFERENCES `comment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `post_read` (
  ...
  KEY `post_id` (`post_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `post_read_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `post` (`id`),
  CONSTRAINT `post_read_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `role_permission` (
  ...
  CONSTRAINT `role_permission_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`),
...
INSERT INTO `user` VALUES (1,'admin1','mac123','15921552946','15921552946@qq.com',0,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(2,'admin2','mac123','15921552947','15921552947@qq.com',0,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00');
...
CREATE TABLE `user_role` (
  ...
  KEY `user_id` (`user_id`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `user_role_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`),
...
-- Dump completed on 2018-10-19 13:45:09
